...
L_max=800  ; % maximum included spherical harmonic degree
...
colormap('parula')
s=spatial_plot(f,theta,phi,0.15,1.0,2);
...
% for i=[0:99]
%	set(gcf,'PaperUnits','inches','PaperPosition',[0 0 3 3]) %150dpi
% 	rotname=sprintf('figs/globerot_%04d', i);
% 	camorbit(2.9,-0.5); drawnow; saveas(gcf,rotname,'png')
% end
